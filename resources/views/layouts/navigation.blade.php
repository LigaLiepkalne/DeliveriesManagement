            ...
            <div class="flex">
                ...
                <div class="space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-nav-link :href="route('clients')" :active="request()->routeIs('clients')">
                        <div class="text-lg"> {{ __('Client List') }} </div>
                    </x-nav-link>
                </div>
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-nav-link :href="route('delivery-types')" :active="request()->routeIs('delivery-types')">
                        <div class="text-lg">   {{ __('Product Delivery Types') }} </div>
                    </x-nav-link>
                </div>
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-nav-link :href="route('last-deliveries')" :active="request()->routeIs('last-deliveries')">
                        <div class="text-lg">   {{ __('Last Deliveries') }} </div>
                    </x-nav-link>
                </div>

                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-nav-link :href="route('dashboard')" :active="request()->routeIs('dashboard')">
                        <div class="text-lg">    {{ __('Inactive Client List (liquids)') }} </div>
                    </x-nav-link>
                </div>
</div>
